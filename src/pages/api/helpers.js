...
export function hiroOrdinalsApiRequest(apiUrl, queryParameters = '', responseType = null){
  ...
  let url =  hiroBaseUrl + apiUrl;
  
  if (queryString){
    url += '?' + queryString;
  }
  
  //console.log("hiro ordinals api request url:" + url);
